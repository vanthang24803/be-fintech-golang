...
func (r *NotificationRepository) GetByUserID(ctx context.Context, userID int64, filter models.NotificationFilter) ([]*models.Notification, error) {
...
func (r *NotificationRepository) MarkAsRead(ctx context.Context, userID int64, ids []int64) error {
...
func (r *NotificationRepository) Delete(ctx context.Context, userID int64, id int64) error {
